...
projectText.b2 = <p>i 2016 deltog jeg i en udviklingsgruppe under <a href="www.cfps.dk">Center For Psykisk Sundhedsfremme</a>, hvor vi tilpassede det meditations-integrerende gruppeforløb 'Åben og Rolig' til unge i gymnasier og på videregående uddannelser - her var jeg samtidig facilitator af et gruppeforløb på et gymnasie i Aalborg.</p>;
projectText.b3 = <p>i 2015 var jeg medudvikler af og forfatter til det resiliensfremmende læringsforløb STÆRKE SAMMEN (4.-6. klasse) hos Red Barnet. Materialet STÆRKE SAMMEN og det tilhørende legekatalog LEGE SAMMEN <a href="http://megafonen.redbarnet.dk/st%C3%A6rke-sammen.aspx?ID=4536">kan downloades gratis her</a>.</p>;
